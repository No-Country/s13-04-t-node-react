        ...
        <section className='mt-3'>
          ...
          <section className='flex flex-col gap-2'>
            <label className='flex-col flex '>País
              ...
              {(errors.nameParking != null) && <span className='text-red-500'>El País es obligatorio</span>}
            </label>
            <label className='flex-col flex '>Provincia/Estado/Departamento
              ...
              {(errors.nameParking != null) && <span className='text-red-500'>La provincia es obligatoria</span>}
            </label>
            ...
            <label className='flex-col flex '>Código postal
              ...
              {(errors.nameParking != null) && <span className='text-red-500'>el código postal es obligatorio</span>}
            </label>
            <label className='flex-col flex '>Calle y numero
              ...
              {(errors.nameParking != null) && <span className='text-red-500'>La calle y el número son obligatorios</span>}
            </label>
          </section>
        </section>
