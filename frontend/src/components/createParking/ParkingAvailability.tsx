	...
	return (
		<>
            ...
            Cantidad de plazas disponibles
						<input className='px-4 py-2 border border-[#D58418] rounded outline-none mt-2' placeholder='Ingresa la cantidad de lugares' type='text' id='capacity' {...register('capacity', { required: true })}
						/>
