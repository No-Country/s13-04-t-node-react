...
const MAPBOX_TOKEN: string = 'pk.eyJ1IjoieWVpbndpbGxpZSIsImEiOiJjbGx2bzVianAxY3VyM2ZwaDAwc2dyd2lyIn0._qZShL6XUUYlIQ_km2IUDg';
...
export const MapStaticView: FC = () => {
    ...
    return (  
        ...
        <div id="map" style={{ position: 'absolute', top: 30, bottom: 50, width: '96%' }} />
