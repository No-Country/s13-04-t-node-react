...
export default function ParkingAvailability(): JSX.Element {
    const {
		register,
		watch,
		handleSubmit,
  ...
  return (
    ...
    <form
            ...
            className="mr-2"
          />
          <label htmlFor="notificationYes">Deseo recibir una notificación cuando un conductor reserve en mi estacionamiento para poder confirmar o rechazar la misma.</label>
          ...
          <button
            className="py-2 text-center bg-[#D58418] rounded-3xl font-semibold mt-8 rounded-3xl"
